...
Undergrad CS coursework, grouped by subject. Each subject has a descriptive folder name and its own `README.md` breaking down what every lab does.
...
| [`computer-networks`](computer-networks/) | Computer Networks — TCP/IP socket clients/servers, from blocking I/O to `select()` multiplexing | C |
